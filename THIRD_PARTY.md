...
`res/raw/licenses.txt` and shows it behind the Licenses button at the foot of
the game screen. It reads with no network, which is also what F-Droid expects.
