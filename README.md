...
The three built-in difficulty modes are mechanically distinct, not just bigger grids:
...
Past the three presets there is a **Custom** mode: pick a grid anywhere from 5×5 to 20×20, set the mine count, and switch fog of war and safe-start on or off independently. No countdown, chord stays on, custom is about layout, not time pressure.
